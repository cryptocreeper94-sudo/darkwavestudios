...
const developerProducts = [
  ...
  },
  {
    ...
    description: "Centralized UI component manager. Update footers, headers, banners, and badges once — changes propagate to all 30 ecosystem apps instantly.",
    icon: Layers,
  ...
  },
  {
    ...
    description: "Real-time health dashboard for all 30 production apps. Live status checks, response times, uptime ring, and category filtering across the entire ecosystem.",
    icon: Activity,
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    { name: "TechCrunch", url: "https://techcrunch.com/submit-a-tip/", type: "Tip submission form", pitch: "Full-stack ecosystem with 30 production apps and 1.8M+ lines of code", icon: Zap },
                    ...
                    { name: "Hacker News (Show HN)", url: "https://news.ycombinator.com/submit", type: "Community submission", pitch: "Technical deep-dive on building a 30-app ecosystem as a solo developer", icon: Terminal },
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    ...
                    { name: "Decrypt", url: "https://decrypt.co/contact", type: "Story pitches", pitch: "Real-world blockchain utility — 30 apps verified through Trust Layer", icon: Boxes },
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    { name: "SaaStr", url: "https://www.saastr.com", type: "SaaS community + events", pitch: "30-app ecosystem with widget marketplace, subscription model, and AI credits system", icon: TrendingUp },
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-3">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-sm text-muted-foreground">Lead with the story — solo developer building a 30-app, 1.8M+ line ecosystem is compelling and rare</p>
                    </div>
                    <div className="flex items-start gap-2">
                      <div className="w-5 h-5 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0 mt-0.5">
