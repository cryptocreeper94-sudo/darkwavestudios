...
const developerProducts = [
  ...
  },
  {
    ...
    description: "Centralized UI component manager. Update footers, headers, banners, and badges once — changes propagate to all 29 ecosystem apps instantly.",
    icon: Layers,
  ...
  },
  {
    ...
    description: "Real-time health dashboard for all 29 production apps. Live status checks, response times, uptime ring, and category filtering across the entire ecosystem.",
    icon: Activity,
          ...
          <GlassCard glow className="rounded-2xl lg:rounded-3xl p-8 lg:p-12">
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    ...
                    { name: "Hacker News (Show HN)", url: "https://news.ycombinator.com/submit", type: "Community submission", pitch: "Technical deep-dive on building a 29-app ecosystem as a solo developer", icon: Terminal },
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    { name: "SaaStr", url: "https://www.saastr.com", type: "SaaS community + events", pitch: "29-app ecosystem with widget marketplace, subscription model, and AI credits system", icon: TrendingUp },
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-3">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-sm text-muted-foreground">Lead with the story — solo developer building a 29-app, 1.8M+ line ecosystem is compelling and rare</p>
                    </div>
                    <div className="flex items-start gap-2">
                      <div className="w-5 h-5 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0 mt-0.5">
