...
const developerProducts = [
  ...
  },
  {
    ...
    description: "Real-time health dashboard for all 33 production apps. Live status checks, response times, uptime ring, and category filtering across the entire ecosystem.",
    icon: Activity,
