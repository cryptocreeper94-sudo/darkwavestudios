...
const categories: ExploreCategory[] = [
  ...
  },
  {
    ...
    description: "Explore the full Trust Layer ecosystem — 29 interconnected apps, a portfolio of live projects, and detailed codebase metrics across 1.8M+ lines of code.",
    cards: [
      {
        label: "Ecosystem",
        description: "All 29 connected applications in one view",
        href: "/ecosystem",
  ...
  },
  {
    ...
    description: "Access free tools and the widget marketplace. Run a website audit, scan AI agents for security, browse 72 embeddable widgets, or explore the developer API.",
    cards: [
      {
        label: "Trust Layer Hub",
        description: "72 embeddable widgets with live previews and pricing",
        href: "/hub",
