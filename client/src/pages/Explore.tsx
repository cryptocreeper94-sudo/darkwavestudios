...
const categories: ExploreCategory[] = [
  ...
  },
  {
    ...
    description: "Explore the full DarkWave ecosystem — 24 interconnected apps, a portfolio of live projects, and detailed codebase metrics across 2.07M+ lines of code.",
    cards: [
      {
        label: "Ecosystem",
