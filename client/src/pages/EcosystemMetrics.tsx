...
const ecosystemMetrics: AppMetric[] = [
  ...
  },
  {
    ...
    breakdown: [
      { language: "TypeScript/TSX", lines: 14000, files: 16 },
      { language: "Backend/Config", lines: 2003, files: 4 },
    ],
    highlights: ["3 Eras (Modern/Medieval/Wild West)", "15 Factions", "75 Situations", "9 NPCs", "Real-time Simulation (1hr = 1hr)", "AI-Generated Content", "Voice Cloning", "Estate Building"],
    icon: Gamepad2,
