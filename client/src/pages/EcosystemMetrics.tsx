...
const ecosystemMetrics: AppMetric[] = [
  ...
  },
  {
    ...
    totalFiles: 5084,
    apiEndpoints: 192,
    stack: ["React 19", "TypeScript", "Vite 7", "Tailwind CSS v4", "shadcn/ui", "Framer Motion", "Recharts", "Wouter", "TanStack Query v5", "Express 5", "PostgreSQL", "Drizzle ORM", "2 WebSocket Servers", "Stripe (Live)", "OpenAI", "ElevenLabs TTS", "Replit Object Storage", "Web Push (VAPID)", "Helmet", "PWA"],
    breakdown: [
      { language: "TypeScript/TSX (59 pages, 79 components)", lines: 148000, files: 5084 },
      { language: "Server (35 modules)", lines: 35124, files: 35 },
      { language: "CSS Styling", lines: 334, files: 1 },
    ],
    highlights: ["Dual PWA System (Happy Eats + TL Driver)", "183,458 LOC, 59 Pages, 79 Components", "192 API Endpoints, 49 DB Tables", "11 Delivery Zones, Zone-Based Batch Ordering", "Stripe Live Checkout + Revenue Dashboard", "Customer Referral Program ($5 Credits)", "9-Theme System, 8 Signal Chat Channels", "Vendor Self-Service Portal + Menu Management", "AI Marketing Hub + Flyer Editor", "Multi-Tenant Franchise Architecture", "CDL Program Directory + Fuel Finder", "Operations Manual + Interactive Demo"],
    icon: Utensils,
