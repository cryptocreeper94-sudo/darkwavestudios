...
const ecosystemMetrics: AppMetric[] = [
  ...
  },
  {
    ...
    totalFiles: 185,
    apiEndpoints: 155,
    stack: ["React 19", "TypeScript", "Vite 7", "Express 5", "PostgreSQL", "Drizzle ORM", "WebSocket", "Stripe", "OpenAI", "ElevenLabs TTS", "Replit Object Storage", "Framer Motion", "TrustLayer SSO", "PWA", "Recharts"],
    breakdown: [
      { language: "TypeScript (Client)", lines: 14800, files: 148 },
      { language: "TypeScript (Server)", lines: 9600, files: 37 },
      { language: "Shared/Config", lines: 2100, files: 12 },
    ],
    highlights: ["53 pages, 9-theme system", "155+ API endpoints, 2 WebSocket servers", "41 database tables, 10 delivery zones", "8 chat channels, bilingual English/Spanish", "Multi-tenant franchise model", "Vendor self-service portal & marketing toolkit", "Zone-based batch ordering", "Operations manual & interactive demo"],
    icon: Utensils,
