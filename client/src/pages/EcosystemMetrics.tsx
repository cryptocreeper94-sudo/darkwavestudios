...
const ecosystemMetrics: AppMetric[] = [
  ...
  },
  {
    ...
    highlights: ["36 pages, 55 UI components", "Spinny AI agent (GPT-5.1 + ElevenLabs)", "Image/Audio/Video/Merge editors", "4-tier Stripe subscriptions", "Signal Chat + TrustLayer SSO", "33 database tables", "108 API endpoints, 2 WebSocket servers", "PWA installable", "105 npm packages"],
    icon: Shield,
