...
const ecosystemMetrics: AppMetric[] = [
  {
    ...
    totalFiles: 350,
    apiEndpoints: 422,
    stack: ["React 18", "TypeScript", "Vite", "Node.js", "Express", "PostgreSQL", "Drizzle ORM", "Solana Blockchain", "Stripe", "OpenAI GPT-4o-mini", "WebSocket", "Trust Layer SSO", "Resend", "Meta Graph API"],
    breakdown: [
      { language: "TypeScript", lines: 38000, files: 145 },
      { language: "React/TSX", lines: 40000, files: 154 },
      { language: "JSON", lines: 4500, files: 38 },
      { language: "CSS", lines: 2500, files: 8 },
      { language: "HTML", lines: 1000, files: 5 },
    ],
    highlights: ["422 API Endpoints", "120+ Tables", "43 Pages", "111 Components", "68+ Retailers"],
    icon: Car,
  ...
  },
  {
    ...
    totalFiles: 5410,
    apiEndpoints: 743,
    stack: ["React 18", "TypeScript", "Vite", "Tailwind CSS v4", "Framer Motion", "Wouter", "TanStack Query", "Node.js", "Express", "Drizzle ORM", "PostgreSQL", "Firebase Auth", "Stripe", "Coinbase Commerce", "WebSocket", "OpenAI GPT-4o", "Solana Blockchain"],
    breakdown: [
      { language: "TypeScript", lines: 380000, files: 3200 },
      { language: "React/TSX", lines: 250000, files: 1800 },
      { language: "JSON/Config", lines: 30000, files: 350 },
      { language: "CSS", lines: 8000, files: 40 },
      { language: "HTML", lines: 4085, files: 20 },
    ],
    highlights: ["5 PWAs", "289 Tables", "743 Endpoints", "230 Pages", "158 Components", "9 Manifests"],
    icon: Shield,
  ...
  },
  {
    ...
    totalFiles: 171,
    apiEndpoints: 147,
    stack: ["React 19", "TypeScript", "Vite 7", "Express 5", "PostgreSQL", "Drizzle ORM", "WebSocket", "Stripe", "OpenAI", "ElevenLabs TTS", "Replit Object Storage", "Solana", "Framer Motion", "TrustLayer SSO", "PWA", "Recharts"],
    breakdown: [
      { language: "TypeScript (Client)", lines: 13248, files: 138 },
      { language: "TypeScript (Server)", lines: 8800, files: 33 },
      { language: "Shared/Config", lines: 852, files: 6 },
    ],
    highlights: ["50 pages, 71 UI components", "147 API endpoints, 2 WebSocket servers", "41 database tables", "55+ client routes", "Multi-tenant franchise model", "Bilingual English/Spanish", "Zone-based batch ordering", "Affiliate referral program"],
    icon: Utensils,
  ...
  },
  {
    ...
    totalLines: 0,
    totalFiles: 20,
    stack: ["React 18", "TypeScript", "Framer Motion", "OpenAI GPT-4o", "WebSocket", "TanStack Query", "Credits System", "Trust Layer"],
    breakdown: [
      { language: "Included in Trust Layer build", lines: 25000, files: 20 },
    ],
    highlights: ["3 Eras (Modern/Medieval/Wild West)", "15 Factions", "75 Situations", "9 NPCs", "Real-time Simulation", "AI-Generated Content", "Voice Interaction"],
    icon: Gamepad2,
  ...
  },
  {
    ...
    totalFiles: 82,
    apiEndpoints: 90,
    stack: ["Expo React Native (SDK 54)", "React 19.1", "TypeScript 5.9", "Expo Router 6.0", "Express 5.0", "PostgreSQL", "Drizzle ORM", "OpenAI GPT-5.2", "ElevenLabs TTS", "Socket.IO 4.8", "Resend 4.0", "React Query 5.83", "Reanimated 4.1", "Zod", "TrustLayer SSO", "PWA"],
    breakdown: [
      { language: "TypeScript/TSX (Frontend)", lines: 14500, files: 46 },
      { language: "TypeScript (Backend)", lines: 7200, files: 35 },
      { language: "JavaScript/Config", lines: 1778, files: 5 },
    ],
    highlights: ["Expo React Native (iOS/Android/Web)", "Voice AI (STT/TTS/Chat via GPT-5.2)", "Blockchain doc vault", "20 screens, 21 components", "90+ API endpoints, 10 DB tables", "CRM + AI lead scoring", "Business suite with OCR", "MLS integration (10+ providers)", "Woman-owned (WOSB)"],
    icon: Building2,
  ...
  },
  {
    ...
    totalFiles: 187,
    apiEndpoints: 132,
    stack: ["React 18", "TypeScript", "Vite", "Express 5", "PostgreSQL", "Drizzle ORM", "Stripe", "OpenAI GPT-5.1", "ElevenLabs TTS", "Replit Object Storage", "Uppy", "Framer Motion", "TrustLayer SSO", "WebSocket", "PWA", "Resend Email"],
    breakdown: [
      { language: "TypeScript/TSX (Frontend)", lines: 68200, files: 138 },
      { language: "TypeScript (Backend)", lines: 34339, files: 43 },
      { language: "CSS", lines: 3444, files: 6 },
    ],
    highlights: ["16 pages, 66 components", "132 API endpoints (57 GET, 53 POST, 8 PATCH, 14 DELETE)", "26 database tables", "4 AI media tools + Spinny AI agent", "Image/Audio/Video/Merge editors", "4-tier Stripe subscriptions", "Signal Chat + TrustLayer SSO", "Multi-tenant family vault with 8 accounts", "PWA installable"],
    icon: Shield,
  ...
  },
  {
    ...
    totalLines: 0,
    totalFiles: 12,
    stack: ["React 18", "TypeScript", "DexScreener API", "Axios", "WebSocket", "Pulse AI Engine", "Trust Layer"],
    breakdown: [
      { language: "Included in Trust Layer build", lines: 7000, files: 12 },
    ],
    highlights: ["Multi-chain (12 chains)", "AI Safety Scoring", "Strike Agent Recs", "ML Price Predictions", "Guardian Score A-F", "Live Trending Feed"],
    icon: Search,
    gradient: "from-green-500 to-emerald-500",
    status: "Production",
  },
