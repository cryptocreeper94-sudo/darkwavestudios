...
const ecosystemMetrics: AppMetric[] = [
  ...
  },
  {
    ...
    totalFiles: 166,
    apiEndpoints: 108,
    stack: ["React 18", "TypeScript", "Vite 7", "Express 5", "PostgreSQL", "Drizzle ORM", "WebSocket", "Stripe", "OpenAI GPT-5.1", "ElevenLabs TTS", "Replit Object Storage", "Uppy", "Framer Motion", "TrustLayer SSO", "PWA", "Recharts"],
    breakdown: [
      { language: "TypeScript (Client)", lines: 30988, files: 119 },
      { language: "TypeScript (Server)", lines: 7659, files: 33 },
      { language: "Shared/Config", lines: 1017, files: 8 },
      { language: "CSS", lines: 369, files: 6 },
    ],
    highlights: ["36 pages, 55 UI components", "108 API endpoints, 2 WebSocket servers", "33 database tables", "39 frontend routes", "105 npm packages", "PWA installable"],
    icon: Utensils,
