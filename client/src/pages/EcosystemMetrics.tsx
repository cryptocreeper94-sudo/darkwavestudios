...
const ecosystemMetrics: AppMetric[] = [
  ...
  },
  {
    ...
    breakdown: [
      { language: "Frontend (client/)", lines: 160671, files: 391 },
      { language: "Server (server/)", lines: 61375, files: 105 },
      { language: "Shared (shared/)", lines: 9460, files: 11 },
      { language: "Pages (233 files)", lines: 127687 },
      { language: "Components (158 files)", lines: 27138 },
    ],
