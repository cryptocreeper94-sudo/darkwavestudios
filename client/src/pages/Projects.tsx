...
const projects = [
  ...
  },
  {
    id: 21,
    title: "Signal Chat",
    description: "Cross-app community messaging platform for the Trust Layer ecosystem. Real-time WebSocket chat, JWT SSO authentication, channel-based conversations, invite system, and user presence. The social backbone connecting all 28 ecosystem apps.",
...
export default function Projects() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEOHead
        title="Portfolio - 28 Web Applications & Ecosystem"
        description="Explore 28 web applications built by DarkWave Studios. From AI trading platforms to staffing systems, venue operations to blockchain infrastructure - see our work in action."
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-16">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto" data-testid="text-projects-subtitle">
            28 live applications powering real businesses. From AI trading platforms to staffing systems, venue operations to blockchain infrastructure.
          </p>
        </motion.div>
