...
const categories: CommandCategory[] = [
  ...
  },
  {
    ...
    description: "The full Trust Layer ecosystem. Browse all 35 connected applications, review codebase metrics, manage the widget marketplace, and access developer documentation.",
    cards: [
      {
        label: "Ecosystem",
        description: "All 35 connected applications with carousels",
        href: "/ecosystem",
