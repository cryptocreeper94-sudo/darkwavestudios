...
const categories: CommandCategory[] = [
  ...
  },
  {
    ...
    description: "The full DarkWave ecosystem. Browse all 24 connected applications, review codebase metrics, manage the widget marketplace, and access developer documentation.",
    cards: [
      {
        label: "Ecosystem",
        description: "All 24 connected applications with carousels",
        href: "/ecosystem",
